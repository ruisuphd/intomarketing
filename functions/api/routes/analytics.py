...
# Must match metrics_source written by engines/analytics_gatherer.py
_LIVE_METRICS_SOURCES = frozenset(
    {"platform_api", "linkedin_api", "x_api"}
)
...
async def get_analytics(
    ...
    live_metrics_available = any(
        snapshot.get("metrics_source") in _LIVE_METRICS_SOURCES
        for snapshot in snapshot_docs
    )
