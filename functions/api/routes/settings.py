...
async def get_settings(tenant: TenantProfile = Depends(require_tenant)):
    return {
        ...
        "beehiiv_publication_id": getattr(tenant, "beehiiv_publication_id", None) or "",
    }
...
class SettingsUpdate(BaseModel):
    ...
    @field_validator("beehiiv_publication_id")
    @classmethod
    def normalize_beehiiv_publication_id(cls, value: str | None) -> str | None:
        if value is None:
            return None
